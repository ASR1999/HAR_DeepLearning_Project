...
def load_uci_features() -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    X_train = _read_txt_matrix(os.path.join(cfg.UCI_DIR, "train", "X_train.txt"))
    y_train = _read_txt_matrix(os.path.join(cfg.UCI_DIR, "train", "y_train.txt")).flatten()
    X_test = _read_txt_matrix(os.path.join(cfg.UCI_DIR, "test", "X_test.txt"))
    y_test = _read_txt_matrix(os.path.join(cfg.UCI_DIR, "test", "y_test.txt")).flatten()
...
def load_hapt_features() -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    X_train = _read_txt_matrix(os.path.join(cfg.HAPT_DIR, "Train", "X_train.txt"))
    y_train = _read_txt_matrix(os.path.join(cfg.HAPT_DIR, "Train", "y_train.txt")).flatten()
    X_test = _read_txt_matrix(os.path.join(cfg.HAPT_DIR, "Test", "X_test.txt"))
    y_test = _read_txt_matrix(os.path.join(cfg.HAPT_DIR, "Test", "y_test.txt")).flatten()
